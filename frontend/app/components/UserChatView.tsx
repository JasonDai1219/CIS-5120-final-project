...
export default function UserChatView({
  ...
  return (
    <div
      ref={scrollRef}
      className="flex h-full flex-col justify-end overflow-x-hidden overflow-y-auto px-4 py-3"
    >
                ...
                {parent && (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-1 text-[10px] font-medium text-[#5C7A4E]">
                      ...
                      {inferred && (
                        <span className="shrink-0" title="AI-inferred reply">
                          ★
                        </span>
                      )}
                    </div>
